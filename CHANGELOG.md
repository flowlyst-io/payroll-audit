...
- Gemini AI provider support for faster AI Insights responses (PA-13)
- Multi-provider architecture allowing switching between Gemini and OpenAI via environment variable (PA-13)
